...
public class Warp10 implements Database {
   ...
   * <p>// Fetches data within a time range:</p><p><code>
   * [ <br>
   *   $read_token <br>
   *   'current' <br>
   ...
   *   '2018-08-30T00:00:00.000Z' <br>
   * ] FETCH <br></code>
   * <p>// Downsample to 1 second buckets:</p><p><code>
   * [ <br>
   *   SWAP <br>
   *   bucketizer.mean <br>
   *   0 1 s 0 <br>
   * ] BUCKETIZE <br></code>
   * <p>// Selects buckets with values greater than 1000:</p><p><code>
   * [ <br>
   *   SWAP <br>
   *   1000.0 mapper.gt <br>
   *   0 0 0 <br>
   ...
   * 'read_token' STORE <br></code>
   *
   * <p>// Generates a list of all bikes: <p><code>
   * [] 'bikes' STORE <br>
   * 0 12 1 - <br>
   * &lt;% <br>
   *   'i' STORE <br>
   ...
   *
   * <p>// Fetches accelerometer readings within the time range: <p><code>
   * [ <br>
   *   $read_token <br>
   *   'accelerometer' <br>
   *   { 'sensor_id' 's_0' } <br>
   ...
   *
   * <p>// Gets bike ids from the fetched data: <p><code>
   * &lt;% <br>
   *   DROP <br>
   ...
   *
   * <p>// Compares all bike ids with fetched bike ids and stores those not included in the fetched data:
   * <p><code>
   ...
   * 'read_token' STORE <br></code>
   *
   * <p>// Fetches data within time range:</p> <p><code>
   * [ <br>
   *   [  <br>
   *     [ <br>
   *       $read_token <br>
   ...
   *   <p>// Selects only buckets with values greater than 1000:</p><p><code>
   *   1000.0 <br>
   *   mapper.gt <br>
   *   0 0 0 <br>
   * ] MAP RSORT <br></code>
   * <p>// Selects last timestamp for each bike_id:</p><p><code>
   *
   * &lt;% <br>
   *   DROP 'gts' STORE <br>
   *   [] 'list' STORE <br>
   ...
   *   '2018-08-30T00:00:00.000Z' <br>
   * ] FETCH <br> </code>
   * <p>// Downsamples data to 1 minute buckets:</p><p><code>
   * [ <br>
   *   SWAP <br>
   *   bucketizer.mean <br>
   *   0 1 m 0 <br>
   ...
   *   MINLONG <br>
   * ] FETCH <br></code>
   * <p>// Selects last value for each bike:</p><p><code>
   * [ <br>
   *   SWAP <br>
   *   mapper.last <br>
   ...
   * 'some token' <br>
   * 'read_token' STORE <br> </code>
   * <p>// Fetches values of particles sensors within a time range:</p><p><code>
   * [ <br>
   *     $read_token <br>
   *     'particles' <br>
   *     { 'sensor_id' 's_34' } <br>
   ...
   *     '2018-08-30T00:00:00.000Z' <br>
   * ] FETCH <br></code>
   * <p>// Downsamples to 1 second buckets:</p>
   * <p><code>
   * &lt;% <br>
   *     DROP 'gts' STORE <br>
   *     [ <br>
   ...
   * [] 'list' STORE <br></code>
   *
   * <p>// Selects distinct coordinates and respective particles values:</p><p><code>
   * &lt;%
   *     SWAP 'gts' STORE <br>
   *     $gts LOCATIONS <br>
   *     'latitudes' STORE <br>
   ...
   * 'read_token' STORE <br></code>
   *
   * <p>// Fetches current sensor data of a bike within a time range:</p><p><code>
   * [ <br>
   *   $read_token <br>
   *   'current' <br>
   *   { 'bike_id' 'bike_8' 'sensor_id' 's_17' } <br>
   ...
   * ] FETCH <br></code>
   *
   * <p>// Downsamples data to 1 second buckets:</p><p><code>
   * [
   *   SWAP <br>
   *   bucketizer.mean <br>
   *   0 1 s 0 <br>
   ...
   * ] MAP <br></code>
   *
   * <p>// Computes overall distance:</p><p><code>
   * [ <br>
   *   SWAP <br>
   *   mapper.hdist  <br>
   *   MAXLONG <br>
   ...
   * 'read_token' STORE <br> </code>
   *
   * <p>// Stores area boundaries:</p><p><code>
   ...
   * ] FETCH <br></code>
   *
   * <p>// Selects last values for each bike:</p><p><code>
   * [ <br>
   *   SWAP <br>
   *   mapper.last <br>
   *   MAXLONG MAXLONG 1 <br>
   * ] MAP <br></code>
   *
   * <p>// Checks if last coordinates lie within the area boundaries:</p><p><code>
   * [ <br>
   *   SWAP <br>
